package com.local.msvc.test.controller.integration;
...
import com.local.msvc.Application;
...
public class HelloControllerIT
{
            ...
            throws Exception
    {
        ...
        assertThat(response.getBody(), startsWith("{\"status\":\"Success\",\"response\":\"Greetings from Local".replace("\\", "")));
